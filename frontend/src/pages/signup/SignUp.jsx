		...
		<div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				<h1 className='text-3xl font-semibold text-center text-gray-300'>
					SignUp <span className='text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-500'> ChatAviax</span>
				</h1>
				...
				<form onSubmit={handleSubmit}>
					...
					<Link
						to={"/login"}
						className='text-sm hover:underline text-gray-50 hover:text-blue-300 mt-2 inline-block'
						href='#'
					>
